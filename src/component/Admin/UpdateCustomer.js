          ...
          <div className="content">
            <form onSubmit={handleSubmits}>
              ...
              <div className="d-flex justify-content-between">
                <button type="submit" className="btn btn-outline-success ms-4">Save</button>
                <button type="button" className="btn btn-outline-danger ms-4" onClick={handleCancel}>Cancel</button>
              </div>
            </form>
        </div>
        </div>
